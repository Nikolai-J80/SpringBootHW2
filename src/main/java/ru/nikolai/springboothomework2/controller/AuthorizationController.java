package ru.nikolai.springboothomework2.controller;
...
import ru.nikolai.springboothomework2.service.AuthorizationService;
...
public class AuthorizationController {
    ...
    public List<Authorities> getAuthorities(@RequestParam("user") @Valid String user, @RequestParam("password") String password) {
